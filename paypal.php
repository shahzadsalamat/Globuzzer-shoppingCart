...
<div>
     <form>
     <h2 align="center">Total price of Product: <?php echo $_REQUEST['totalprice'] ?> </h2>
          <h2 align="center">Product name: <?php echo $_REQUEST['pname'] ?> </h2>

     <input type="radio" name="price" value="<?php echo $_REQUEST['totalprice'] ?>" /> <input type="text" name="package1" value="<?php echo $_REQUEST['pname'] ?> costs <?php echo $_REQUEST['totalprice'] ?> " readonly />
